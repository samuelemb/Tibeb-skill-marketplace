...
### Critical Components
1. Authentication and Role Management: `backend/src/middleware/auth.ts`  
2. Escrow and Payment Flow: `backend/src/services/payment.service.ts`  
3. Real-Time Messaging: `backend/src/services/socket.service.ts`  
4. Admin Moderation: `backend/src/controllers/admin.controller.ts`
